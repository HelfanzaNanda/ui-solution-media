    ...
    <main class="flex-1 overflow-y-auto bg-gray-50 overflow-x-auto">
        ...
        <section class="bg--dark py-20 min-h-screen w-screen flex flex-col">
            ...
            <div class="flex flex-col mx-auto">
                ...
                <h1 class=" font--gilroy-bold leading-none text--gradient" style="height: 250px; font-size: 220px;">Planning</h1>
                <div class="flex">
                    <div class="w-1/2">
        ...
        <section class="bg--dark min-h-screen w-screen flex flex-col py-20">
            <div class="flex flex-col mx-auto mt-20">
                ...
                <h1 class="text-white font--gilroy-bold leading-none text--gradient" style="font-size: 220px">Research</h1>
        ...
        <section class="bg--dark min-h-screen w-screen flex flex-col py-20">
            <div class="flex flex-col mx-auto mt-20">
                ...
                <h1 class="text-white font--gilroy-bold leading-none text--gradient" style="font-size: 220px">Development</h1>
        ...
        <section class="bg--dark min-h-screen w-screen flex flex-col py-20">
            <div class="flex flex-col mx-auto mt-20">
                ...
                <h1 class="text-white font--gilroy-bold leading-none text--gradient" style="font-size: 220px">Deployment</h1>
                <div class="flex px-20 mt-10">
                    <div class="w-1/2"></div>
                    <div class="w-1/2">
                        <p class="text-white opacity-60">
