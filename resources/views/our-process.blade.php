...
<body>
    <div class="flex flex-col h-screen">
        <div class="absolute px-10 top-0 left-0">
            <div>
                <img src="{{ asset('assets/images/logo.png') }}" alt="">
            </div>
        </div>
        <div class="absolute px-20 top-0 right-0 py-10">
            <div>
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50">
            ...
            <section class="bg-gray-900 p-20">
                <div class="flex flex-col space-y-20 mb-20">
                ...
                <div class="flex flex-col p-10 rounded-2xl"
                    style="background-image: url({{ asset('assets/images/bg.png') }}); height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;">
                    <h1 class="text-white text-7xl" style="font-family: Gilroy-Bold;">
                        Connect
                    </h1>
            ...
            <section class="bg-gray-700 p-20 -mt-48" style="z-index: -1;">
